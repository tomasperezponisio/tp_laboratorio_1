	        ...
	        switch(menu())
	        {
	            ...
	            case 3:
	                if (flagOpA == 0)
	                {
	                    if (flagOpB == 0)
	                    {
	                        printf("Hay que ingresar ambos operandos para poder calcular las operaciones\n");
	                        break;
	                    }
	                    else
	                    {
	                ...
	                else
	                {
	                    ...
	                    else
	                    {
	                        ...
	                        {
	                            printf("   La suma no se hizo, direccion de memoria = NULL");
	                            flagSuma = 0;
	                        }
	                        ...
	                        {
	                            printf("   La resta no se hizo, direccion de memoria = NULL\n");
	                            flagResta = 0;
	                        }
	                        ...
	                        {
	                            case 0:
	                                printf("   La division no se hizo, direccion de memoria = NULL\n");
	                                flagDivision = 0;
	                            break;
	                            case 1:
	                        ...
	                        if (multiplicar(operandoA, operandoB, &resultadoMultiplicacion))
	                        {
	                        ...
	                        {
	                            printf("   La multiplicacion no se hizo, direccion de memoria = NULL\n");
	            ...
	            case 4:
	                if (flagCalcular == 0)
	                {
	                    printf("Hay que calcular las operaciones para mostrar los resultados\n");
	                }
	                else
	                {
